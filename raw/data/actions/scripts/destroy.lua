function onUse(cid, item, frompos, item2, topos)
 	if (item2.itemid >= 3805 and item2.itemid <= 3810) or
 		...
 		(item2.itemid == 2095 or item2.itemid == 2098 or item2.itemid == 2782 or item2.itemid == 2101 or item2.itemid == 2104 or item2.itemid == 2105 or item2.itemid == 1775 or item2.itemid == 2602 or item2.itemid == 1619 or item2.itemid == 2064) or
