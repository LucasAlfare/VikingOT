...
elseif msgcontains(msg, 'premium') or msgcontains(msg, 'premmy') then
			selfSay('How many days of premium do you want 15 or 30?')
			talk_state = 8

		end
	
			if msgcontains(msg, '30') and talk_state == 8 then
				if getPlayerItemCount(cid,6527) >= 100 then
                                if doPlayerRemoveItem(cid,6527,100) == 1 then
					selfSay('/premium '.. creatureGetName(cid) ..', 31')
...
talk_state = 8
            if getPlayerItemCount(cid,6527) >= 50 then
                if doPlayerRemoveItem(cid,6527,50) == 1 then
                 		selfSay('/premium '.. creatureGetName(cid) ..', 16')
